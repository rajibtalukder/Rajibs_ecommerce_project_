...
class SumniPrinter {
  static Future<void> printText(bool isTableAvailable) async {
    ...
    await SunmiPrinter.printText(
        homeController.settings.value.data![0].value ?? "klio");
...
/*    await SunmiPrinter.printText(
    ...
    await SunmiPrinter.setAlignment(SunmiPrintAlign.CENTER);
    await SunmiPrinter.printText(
        'Thanks for ordering with ${homeController.settings.value.data![0].value}');

    await SunmiPrinter.lineWrap(1);
    await SunmiPrinter.setFontSize(SunmiFontSize.MD);
    await SunmiPrinter.setAlignment(SunmiPrintAlign.CENTER);
    await SunmiPrinter.printText('Powered by klio.');
