...
import 'package:klio_staff/mvc/model/production_unit_item_model.dart';
import '../constant/color.dart';
import '../constant/value.dart';
import '../mvc/model/Ingredient_list_model.dart';
...
class Utils {
  ...
  static double calcSubTotalQuantityAmount(List<dynamic> list) {
    double itemTotal = 0;
    for (var element in list) {
  ...
  static double calcTotalQuantityAmount(List<ProductionUnitItemModel> list) {
    double itemTotal = 0;
    for (var element in list) {
